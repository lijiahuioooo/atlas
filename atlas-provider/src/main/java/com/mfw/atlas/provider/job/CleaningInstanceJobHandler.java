...
@JobHandler(value = "cleaningInstanceJobHandler")
@Component
@Slf4j
public class CleaningInstanceJobHandler extends IJobHandler {
    @Autowired
    ...
    public ReturnT<String> execute(String param) throws Exception {
        try {
            List<InstancePO> instancePOList = instanceManager.getOfflineInstance(1);
